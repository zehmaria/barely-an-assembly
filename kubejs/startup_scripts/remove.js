...
hide3('immersiveengineering:', ['sword', 'pickaxe', 'axe', 'shovel', 'hoe'], '_steel');
...
hide2('mekanism:', ['cardboard_box', 'electric_bow', 'atomic_disassembler', 'creative_bin', 'restrictive_transporter', 'diversion_transporter', 'logistical_sorter', 'creative_fluid_tank', 'creative_energy_cube', 'enriched_iron', 'meka_tool', 'antiprotonic_nucleosynthesizer', 'personal_chest', 'electric_pump', 'fluidic_plenisher', 'osmium_compressor', 'robit', 'digital_miner', 'module_base', 'modification_station', 'hdpe_elytra', 'upgrade_stone_generator', 'laser_tractor_beam', 'basic_compressing_factory', 'advanced_compressing_factory', 'elite_compressing_factory', 'ultimate_compressing_factory', 'scuba_mask', 'dust_sulfur','scuba_tank', 'dust_coal', 'dust_charcoal']);

hide1(['mekanism:basic_tier_installer', 'mekanism:elite_tier_installer', 'mekanism:ultimate_tier_installer', 'mekanism:elite_induction_cell', 'mekanism:elite_induction_provider', 'mekanism:elite_pressurized_tube', 'mekanism:elite_thermodynamic_conductor', 'mekanism:elite_chemical_tank', 'mekanism:teleporter_frame', 'mekanism:elite_bin',
       'mekanism:boiler_casing', 'mekanism:boiler_valve', 'mekanism:superheating_element',
       'mekanism:ingot_refined_obsidian', 'mekanism:hdpe_stick']);
